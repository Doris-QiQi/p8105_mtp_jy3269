...
**Brief Introduction to the Raw Data:**
  ...
  * To ensure the measurement accuracy, a standard object is also weighed and recorded occasionally as a reference. 
...
The raw data is imported from an excel spreadsheet. Because of the merged cells, the original column names are not correct in `raw_data`.
...
I solved this problem by extract the first row as column names and rename the 
```{r}
